					...
					<div class="right_editAccount">
						...
						<!-- 	<div class="booking_details_show">
							 ...
							 <div class="booking-page-blog">
					             <h3>Comentario &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="add_comments.php" style="color: white;"><button style="    width: 211px;
    height: 33px;
    border-radius: 5px;
    font-size: 19px;
    margin-left: 146px;">Agregar comentario</button></a></h3>
					            <div class="b-p-b-1">
					            <?php

					         $bokkd=mysqli_query($conn,"select * from comment where user_id='".$_SESSION['user_id']."' order by id desc");
