...
<div class="filter_salon_warrper">
	...
	<div class="container">
		...
		<div class="filter_blog">
			<p style="float: right;"><button style="width: 133px;
				border: 1px;
				height: 43px;
				background: #2EDAAA !important;
				color: white;">Listar</button> &nbsp;<a href="promotionsalon.php"><button style="    width: 133px;
				border: 1px;
				height: 43px;
				background: #2EDAAA !important;
				...
				<div class="col-sm-3">
						...
						<div class="filter_blog_1">
							...
							<!-- <select name="category" class="form-control" placeholder=" Buscar tipo de servicio" onchange="getsubcat(this.value);">
								...
								<div class="filter_blog_1">
									...
									<div class="radio_div cmsradio_div">
										...
										<input class="star star-5" id="star-5" type="radio" name="star" value="5" onchange="review(this.value);"/>
										<label class="star star-5" for="star-5"></label>

										<input class="star star-4" id="star-4" type="radio" name="star" value="4" onchange="review(this.value);"/>
										<label class="star star-4" for="star-4"></label>

										<input class="star star-3" id="star-3" type="radio" name="star" value="3" onchange="review(this.value);"/>
										<label class="star star-3" for="star-3"></label>

										<input class="star star-2" id="star-2" type="radio" value="2" name="star" onchange="review(this.value);"/>
										<label class="star star-2" for="star-2"></label>

										<input class="star star-1" id="star-1" type="radio" name="star" value="1" onchange="review(this.value);" />
							...
							<div class="filter_blog_1">
								...
								<div class="radio_div">
									...
									<input type="range" name="price" onchange="rangesdistance(this.value);" class="form-control" min="2" id="range_weight2" max="10" selected value="2" oninput="range_weight_disp1.value = range_weight2.value" >
							...
							<div class="filter_blog_1">
								...
								<div class="input-group input_filter">
									...
									<select class="form-control" onchange="showbrand(this.value);"/>
					...
					<div class="col-sm-9">
						...
						<div class="show_salon_div" id="showexpertss">
...
<script type="text/javascript">
  ...
  function showPosition(position) {
    ...
    window.location="<?php echo $baseurl;?>salonfilter.php?category=<?php echo $_GET['category'];?>&service=<?php echo $_GET['service'];?>&adress=<?php echo $_GET['adress'];?>&salon=<?php echo $_GET['salon'];?>&lat="+clatt+"&long="+clongi;
