				...
				<div class="right_editAccount">
					...
					<div class="booking_show-blog">
						...
						<div class="booking-page-blog">
							...
							<form method="POST" id="createtickt" enctype="multipart/form-data">
								<div class="col-sm-6">

									<div class="form-group">

										<label>Seleccionar tipo de incidente *</label>

										<select name="incident_type" class="form-control" required="required">

											<option value="1">Plataforma</option>

											<option value="4">Servicio de salon</option>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<label>Breve descripción sobre el incidente *</label>

										<textarea class="form-control" name="incident_desc" required="required"></textarea>
...
<!-- 
								<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<label>HelpDesk asignado *</label>

										<input type="text" class="form-control" placeholder="" name="helpdesk_assigned" value="" required="required" >
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<input type="file" class="choosefile form-control" name="incident_image" >
								...
								<div class="col-sm-12">
									...
									<button type="submit" class="login_btn pull-left">Crear Ticket </button>
...
error: function(){}          
	...
	$(document).ready(function (tickets) {
		$("#createtickt").on('submit',(function(tickets) {
 	//alert();
 	$("#form_abc1_img").show();
 	tickets.preventDefault();
 	$.ajax({
 		url: "php/create_tickets.php",
 		type: "POST",
 		data:  new FormData(this),
 		contentType: false,
 		cache: false,
