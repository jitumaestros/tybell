...
$strtotime1=strtotime($_GET['book_date']);
...
$schedules=$_GET['book_date'].' '.$_GET['book_time'];
$month=date('m');

$mysqld = mysqli_query($conn,"insert into bookings set user_id='".$_SESSION['user_id']."',full_name='".$_GET['name']."',email='".$_GET['email']."',phone='".$_GET['phone_number']."',payment_by='cash',promo_code='".$_GET['promocode']."',schedule_time='".$_GET['book_time']."',service_id='".$_GET['serviceid']."',service_price='$price1',total_amount='".$_GET['price']."',schedule_date='".$_GET['book_date']."',salon_id='".$_GET['salon_id']."',dates='$strtotime1',strtotime='$strtotime',status='1',order_ref='$order_ref1',staffid='".$_GET['staffid']."',guest_name='$guest_name',schedule='$schedules',month='$month',payment_status='1',service_price_level='".$_GET['service_price_level']."'");

$bookid=mysqli_insert_id($conn);


$mysqld = mysqli_query($conn,"insert into payment set user_id='".$_SESSION['user_id']."',booking_id='".$bookid."',amount='".$price1."',total_amount='".$_GET['price']."',payment_status='".$_GET['st']."',txnid='".$_GET['tx']."',strtotime='".$strtotime."',salon_id='".$_GET['salon_id']."',service_id='".$_GET['serviceid']."'");
...
foreach ($servci1d as $key => $valusae) { 
	...
	mysqli_query($conn,"insert into requested_service set service_id='$valusae',booking_id='$bookid',user_id='".$_SESSION['user_id']."',salon_id='".$_GET['salon_id']."' ");
}
