...
<select class="dert" style="" onchange="rangesdistance(this.value,'<?php echo $_GET['adress'];?>','<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>','<?php echo $_GET['category'];?>','<?php echo $_GET['service'];?>','<?php echo $_GET['salon'];?>');">
...
<option value="10">10 km</option>
			...
			<!-- <button style=" width: 133px;
				...
				color: white;">Listar</button> -->


				 &nbsp;<a href="showsalon.php?category=<?php echo $_GET['category'];?>&service=<?php echo $_GET['service'];?>&adress=<?php echo $_GET['adress'];?>&lat=<?php echo $_GET['lat'];?>&long=<?php echo $_GET['long'];?>" ><button style="width: 133px;border: 1px;height: 43px;background: #2EDAAA !important;color: white;">Ver en Mapa</button></a> 

				 </p>

				<div class="col-sm-3">

					<div class="left_filter_blog">

						<div class="filter_blog_1">

							<b class="filter_title">Precio</b>
								...
								<form method="post" id="loginform1" enctype="multipart/form-data">
									...
									<div class="row">
										<div class="col-sm-12">
											...
											<div id="slider-range" onclick="selecteall();"></div>
										</div>
									</div>
									<div class="row slider-labels">


										<input type="hidden" name="val" value="<?php echo $_GET['adress'];?>">

										<input type="hidden" name="latitude" value="<?php echo $_GET['lat'];?>">

										<input type="hidden" name="longitude" value="<?php echo $_GET['long'];?>">



										<input type="hidden" name="salon" value="<?php echo $_GET['salon'];?>">
										...
										<div class="col-xs-6 caption">
											<input type="hidden" name="minimumprice" value="" id="total2"  >
											<strong>Min:</strong> <span id="slider-range-value1"></span>
										</div>
										<div class="col-xs-6 text-right2 caption" >
											<strong>Max:</strong> <span id="slider-range-value2"></span>

											<input type="hidden" name="maxmumprice" value="" id="total1" onchange="selecteall()" >
						...
						<div class="filter_blog_1">
							...
							<b class="filter_title">Ranking</b>

							<div class="radio_div cmsradio_div">


								<input class="star star-5" id="star-5" type="radio" name="star" value="5" onchange="review(this.value,'<?php echo $_GET['adress'];?>','<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>','<?php echo $_GET['category'];?>','<?php echo $_GET['service'];?>','<?php echo $_GET['salon'];?>');"/>
								<label class="star star-5" for="star-5"></label>


								<input class="star star-4" id="star-4" type="radio" name="star" value="4" onchange="review(this.value,'<?php echo $_GET['adress'];?>','<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>','<?php echo $_GET['category'];?>','<?php echo $_GET['service'];?>','<?php echo $_GET['salon'];?>');"/>
								<label class="star star-4" for="star-4"></label>



								<input class="star star-3" id="star-3" type="radio" name="star" value="3" onchange="review(this.value,'<?php echo $_GET['adress'];?>','<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>','<?php echo $_GET['category'];?>','<?php echo $_GET['service'];?>','<?php echo $_GET['salon'];?>');"/>
								<label class="star star-3" for="star-3"></label>



								<input class="star star-2" id="star-2" type="radio" value="2" name="star" onchange="review(this.value,'<?php echo $_GET['adress'];?>','<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>','<?php echo $_GET['category'];?>','<?php echo $_GET['service'];?>','<?php echo $_GET['salon'];?>');"/>
								<label class="star star-2" for="star-2"></label>


								<input class="star star-1" id="star-1" type="radio" name="star" value="1" onchange="review(this.value,'<?php echo $_GET['adress'];?>','<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>','<?php echo $_GET['category'];?>','<?php echo $_GET['service'];?>','<?php echo $_GET['salon'];?>');" />
					...
					<div class="filter_blog_1">
						...
						<b class="filter_title">Distancia</b>

						 <!-- <div class="radio_div">

							<input type="range" name="price" onchange="rangesdistance(this.value,'<?php echo $_GET['adress'];?>','<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>','<?php echo $_GET['category'];?>','<?php echo $_GET['service'];?>','<?php echo $_GET['salon'];?>');" class="form-control" min="2" id="range_weight2" max="10" selected value="2" oninput="range_weight_disp1.value = range_weight2.value" >
							<output  id="range_weight_disp1">2</output>
						</div>  -->
						<div class="range-slider">
							<input class="range-slider__range" type="range" name="price" onchange="rangesdistance(this.value,'<?php echo $_GET['adress'];?>','<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>','<?php echo $_GET['category'];?>','<?php echo $_GET['service'];?>','<?php echo $_GET['salon'];?>');" class="form-control" min="2" id="range_weight2" max="10" selected value="2" oninput="range_weight_disp1.value = range_weight2.value" >
							<span class="range-slider__value" id="range_weight_disp1">2</span>
						</div>
					...
					<div class="filter_blog_1">
						...
						<b class="filter_title">Marca de productos</b>

						<div class="input-group input_filter">

							<select class="form-control" onchange="showbrand(this.value,'<?php echo $_GET['adress'];?>','<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>','<?php echo $_GET['category'];?>','<?php echo $_GET['service'];?>','<?php echo $_GET['salon'];?>');"/>
								<option value="">Seleccionar Marca de productos </option>

								<?php

								$salnid=mysqli_fetch_array(mysqli_query($conn,"select * from users where role='2' and district='".$_GET['adress']."'"));


								$sqlii=mysqli_query($conn,"select * from service where salon_id='".$salnid['id']."' and brand!=''");
								while($BN=mysqli_fetch_array($sqlii)){

									?>
									<option value="<?php echo $BN['brand'];?>"><?php echo $BN['brand'];?></option>
									<?php }?>
								</select>
				...
				<div class="col-sm-9">
					...
					<div class="show_salon_div heuight" id="showexpertss">
						...
						if($_GET['salon']!=''){
							...
							$sqliii=mysqli_query($conn,"select * from users where role='2' and business_name='".$_GET['salon']."' ");
				...
				//$volume[$key]  = $slnw['dis'];
							...
							<div class="sallon_detail_blog2">
								...
								<div class="blog2_salon">
									<?php $srev=mysqli_query($conn,"select * from service where salon_id='".$sln['id']."' ");
									$r=rand();
											...
											<div class="accordtion_data" id="accordio1<?php echo $r;?>" style="display: none;">                     
												...
												<div class="accordion_content">
													...
													<ul>
														...
														<a href="saloon_details.php?id=<?php echo $sln['id'];?>$dates=<?php echo $_GET['dates'];?>"><input type="button" class="go_btn" value="Ir al centro" name="">
              ...
              */
              ...
              $srev=mysqli_query($conn,"select * from service where salon_id='".$sln['id']."' and category_id='".$_GET['category']."' ");
              $r=rand();
              while($sernm=mysqli_fetch_array($srev)){
          ...
          <div class="BrowseResultService--container--ec64db BrowseResultService--alternateRowStyle--52772e">
          	...
          	<div class="BrowseResultService--infoContainer--1981fe">
          		...
          		<div class="BrowseResultService--name--bd91c5">
          			...
          			<a href="saloon_details.php?id=<?php echo $sln['id'];?>&category_id=<?php echo $_GET['category'];?>&dates=<?php echo $_GET['dates'];?>&subcategory_id=<?php echo $_GET['service'];?>"><?php echo $sernm['name'];?></a>
          			
          			<?php }else{ ?>
          			<a href="saloon_details.php?id=<?php echo $sln['id'];?>&dates=<?php echo $_GET['dates'];?>"><?php echo $sernm['name'];?></a>
          				...
          				<div class="accordtion_data" id="accordio1<?php echo $r;?>" style="display: none;">                     
          					...
          					<div class="accordion_content">
          						...
          						<ul>
          							...
          							<?php if($_GET['category']!=''){?>
          							<a href="saloon_details.php?id=<?php echo $sln['id'];?>&category_id=<?php echo $_GET['category'];?>&dates=<?php echo $_GET['dates'];?>&subcategory_id=<?php echo $_GET['service'];?>"><input type="button" class="go_btn" value="Ir al centro" name=""></a>
          							<?php }else{ ?>
          							<a href="saloon_details.php?id=<?php echo $sln['id'];?>&dates=<?php echo $_GET['dates'];?>"><input type="button" class="go_btn" value="Ir al centro" name=""></a>
...
function rangespriceservice(id,val){
//alert(id);
jQuery.ajax({
	url: "rangespriceservice.php",
	type: "POST",
	data: "id="+id+"&val="+val,
...
function rangesdistance(id,val,latitude,longitude,category,service,salon){

	jQuery.ajax({
		url: "rangesdistanceseln.php",
		type: "POST",
		data: "id="+id+"&val="+val+"&latitude="+latitude+"&longitude="+longitude+"&category="+category+"&service="+service+"&salon="+salon,
...
function review(id,val,latitude,longitude,category,service,salon){
//alert(category);
...
function showbrand(id,val,latitude,longitude,category,service,salon){
//alert(id);

jQuery.ajax({
	url: "showbrandservice.php",
	type: "POST",
	data: "id="+id+"&val="+val+"&latitude="+latitude+"&longitude="+longitude+"&category="+category+"&service="+service+"&salon="+salon,
...
<script type="text/javascript">
	...
	function showPosition(position) {
		...
		window.location="<?php echo $baseurl;?>salonfilter.php?category=<?php echo $_GET['category'];?>&service=<?php echo $_GET['service'];?>&adress=<?php echo $_GET['adress'];?>&salon=<?php echo $_GET['salon'];?>&dates=<?php echo $_GET['dates'];?>&lat="+clatt+"&long="+clongi;
...
$(document).ready(function() {
  ...
  rangeSlider.noUiSlider.on('update', function(values, handle) {
  	...
  	var xx= document.getElementById('slider-range-value1').innerHTML = values[0];

  	$("#total2").val(xx);


  	var xs= document.getElementById('slider-range-value2').innerHTML = values[1];
...
.select:hover
{
	background-color: #2EDAAA !important;
	color: white; 
}
.select:focus
{
