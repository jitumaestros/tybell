		...
		<div class="blog2_salon">
			...
			$date= date('H:i'); 
              ...
              */
              ...
              $srev=mysqli_query($conn,"select * from service where brand='".$id."' and salon_id='".$sln['id']."' ");
              $r=rand();
			...
			<div class="sallon_detail_blog2">
              ...
              */
              ...
              if($category!=''){
              	...
              	$srev=mysqli_query($conn,"select * from service where brand='".$id."' and salon_id='".$sln['id']."' and category_id='$category' and subcategory_id='$service'");
              }else{
              	$srev=mysqli_query($conn,"select * from service where brand='".$id."' and salon_id='".$sln['id']."'");
