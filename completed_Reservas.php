...
<div class="custom_col-8">
					...
					<div class="right_editAccount">
						...
						<!-- 	<div class="booking_details_show">
					         ...
					         $bokkd=mysqli_query($conn,"select * from bookings where user_id='".$_SESSION['user_id']."' and booking_status ='4'order by id desc");
...
/*	$sern=mysqli_fetch_array(mysqli_query($conn,"select * from service where id='".$bkkstatus['service_id']."'"));
*/


					         ?>
					               <a href="myaccount2.php?bookingid=<?php echo $bkkstatus['id'];?>">
					                <div class="booking-secion-1">
					                    <div class="booking-section-blog-1">
					                      <p><b><?php echo date('D M d', $bkkstatus['dates']);?></b></p>
					                      <p><?php echo $bkkstatus['schedule_time'];?></p>
					                    </div>
					                    <div class="booking-section-blog-2">
					                      <p><b><?php echo $sernm;?></b></p>
					                      <p><?php if($bkkstatus['booking_status']=='2'){ ?>
					                      <button>Cancelada</button>


<?php }else{} echo $sln['business_name'];?></p>
					                    </div>
					                </div>
