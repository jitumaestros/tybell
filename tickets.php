					...
					<div class="right_editAccount">
						...
						<!-- 	<div class="booking_details_show">
							 ...
							 <div class="booking-page-blog">
					             <h3>Ingreso de incidentes &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="create_ticket.php" style="color: white;"><button style="    width: 168px;
    height: 33px;
    border-radius: 5px;
    font-size: 19px;
    margin-left: 146px;">Crear Ticket</button></a></h3>
					            <div class="b-p-b-1">
					            <?php

					         $bokkd=mysqli_query($conn,"select * from tickets where user_id='".$_SESSION['user_id']."' order by id desc");
					         ...
					         ?>
					                <div class="booking-secion-1">
					                    <div class="booking-section-blog-1">
					                     ...
					                     <p>Fecha de creación del ticket :-</p>

					                     <p>HelpDesk asignado:- </p>

					                    </div>
					                     <div class="booking-section-blog-2">
                                          <p><b><?php if($bkkstatus['incident_type']=='1'){ echo "Plataforma";}else if($bkkstatus['incident_type']=='2'){ echo "Pago";} else{ echo "Otro";}?></b></p>
					                      <p><b><?php echo $bkkstatus['incident_desc'];?></b></p>
					                      <p><b><?php echo date('d-m-Y H:i a',$bkkstatus['dates']);?></b></p>

					                      <p><b><?php echo $bkkstatus['helpdesk_assigned'];?></b></p>
