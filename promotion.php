...
<div class="filter_salon_warrper">
	...
	<div class="container">
		...
		<div class="filter_blog">
			<p class="button-btn" ><button style="width: 133px;
				border: 1px;
				height: 43px;
				background: #2EDAAA !important;
				color: white;">Listar</button> &nbsp;<a href="promotionsalon.php" target="_blank"><button style="    width: 133px;
				border: 1px;
				height: 43px;
				background: #2EDAAA !important;
				color: white;">Ver en Mapa</button></a> </p>
				...
				<div class="col-sm-3">
					...
					<div class="left_filter_blog">
						...
						<div class="filter_blog_1">
							...
							<!-- <select name="category" class="form-control" placeholder=" Buscar tipo de servicio" onchange="getsubcat(this.value);">
								...
								<div class="input-group input_filter">
									...
									<select name="service" class="form-control" placeholder=" Buscar tipo de servicio" id="change" onchange="showsubcategorypromotion(this.value);">
								...
								<div class="input-group input_filter">
									...
									<select  type="text" name="adress" class="form-control" value="" placeholder="Introduce tu dirección" onchange="showdistrictpromotion(this.value);" >
								...
								<div class="filter_blog_1">
									...
									<div class="radio_div cmsradio_div">
										...
										<input class="star star-5" id="star-5" type="radio" name="star" value="5" onchange="review(this.value,'<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>');"/>
										<label class="star star-5" for="star-5"></label>

										<input class="star star-4" id="star-4" type="radio" name="star" value="4" onchange="review(this.value,'<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>');"/>
										<label class="star star-4" for="star-4"></label>

										<input class="star star-3" id="star-3" type="radio" name="star" value="3" onchange="review(this.value,'<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>');"/>
										<label class="star star-3" for="star-3"></label>

										<input class="star star-2" id="star-2" type="radio" value="2" name="star" onchange="review(this.value,'<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>');"/>
										<label class="star star-2" for="star-2"></label>

										<input class="star star-1" id="star-1" type="radio" name="star" value="1" onchange="review(this.value,'<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>');" />
							...
							<div class="filter_blog_1">
								...
								<div class="range-slider">
									  <input class="range-slider__range"  type="range" name="price" onchange="rangesdistance(this.value,'<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>');" class="form-control" min="2" id="range_weight2" max="10" selected value="2" oninput="range_weight_disp1.value = range_weight2.value" >
							...
							<div class="filter_blog_1">
								...
								<div class="input-group input_filter">
									...
									<select class="form-control" onchange="showbrand(this.value,'<?php echo $_GET['lat'];?>','<?php echo $_GET['long'];?>');"/>
									<option value="">Seleccionar Marca de productos </option>

									<?php


									$sqlii=mysqli_query($conn,"select * from service where brand!=''");
...
$offercountq=mysqli_num_rows(mysqli_query($conn,"select * from promotion where salon_id='".$sln['id']."' and status='0'"));
										if($offercountq >0){
								?>
...
function showdistrictpromotion(id){
//alert(id);
jQuery.ajax({
	url: "showdistrictpromotion.php",
	type: "POST",
	data: "id="+id,
...
function rangesdistance(id,latitude,longitude){
//alert(id);

jQuery.ajax({
	url: "promdistanceseln.php",
	type: "POST",
...
function review(id,latitude,longitude){
	//alert(category);

	jQuery.ajax({
		url: "reviewpromsalon.php",
		type: "POST",
	data: "id="+id+"&latitude="+latitude+"&longitude="+longitude,
...
function showbrand(id,latitude,longitude){
//alert(id);

jQuery.ajax({
	url: "showbrandprom.php",
	type: "POST",
	data: "id="+id+"&latitude="+latitude+"&longitude="+longitude,
...
function showcategorypromotion(id){
//alert(id);
jQuery.ajax({
	url: "showcategorypromotion.php",
	type: "POST",
	data: "id="+id,
...
function showsubcategorypromotion(id){
//alert(id);
jQuery.ajax({
	url: "showsubcategorypromotion.php",
	type: "POST",
	data: "id="+id,
