		...
		<div class="sallon_detail_blog2">
			...
			<div class="blog2_salon">
              ...
              */
              ...
              $srev=mysqli_query($conn,"select * from service where salon_id='".$sln['id']."' ");
              $r=rand();
...
//echo $value['latitude'].'  lat'.$value['longitude'].' dis'.$value['dis'].'<br>';
			...
			<div class="sallon_detail_blog2">
              ...
              */
              ...
              if($category!=''){
              	$srev=mysqli_query($conn,"select * from service where salon_id='".$sln['id']."' and category_id='$category'");
              }
              else{
              	$srev=mysqli_query($conn,"select * from service where salon_id='".$sln['id']."'");
